R = {
  getSign: function (e) {
    ...
    var t = []
    for (var n in e) t.push(n + '=' + (R.isBaseParams(n) ? e[n] : encodeURIComponent(e[n])))
    var i = t.join('&').replace(/~/g, '%7E'),
      o = i.split('&'),
      s = o.sort().join('&')
    ;-1 != s.indexOf(':') && (s = s.replace(/:/g, '%3A')), -1 != s.indexOf('@') && (s = s.replace(/@/g, '%40')), -1 != s.indexOf(',') && (s = s.replace(/,/g, '%2C')), -1 != s.indexOf('%20') && (s = s.replace(/%20/g, '+'))
  ...
  getParamsAPP: function (e) {
    ...
    for (var n in (t && ((t.appkey = 'i2n1Vu'), (t.appsecret = 'rYH12u'), (t.appversion = '4.2.0'), (t.channel = 'app_web'), (t.market = 'AppStore'), (t.sign = R.getSign(t))), t))
      if (!R.isBaseParams(n)) {
        let e = t[n]
        ;(e = encodeURIComponent(e)), (t[n] = a.encode(e))
      }
    return t
  },
  isBaseParams(e) {
